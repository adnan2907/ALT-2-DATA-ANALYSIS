...
#finding how many runways there is 
...
#starting v8.0
#making into graph number of times airports are repeating 
import pygal
...
twenty_runways = 1
twenty_six_runways = 1
thirty_one_runways = 2
thirty_two_runways = 1
fourty_two_runways = 1
fourty_eight_runways = 1
one_hundred_seventy_runways = 1

airport_chart = pygal.Bar()
airport_chart.x_title = "airport chart"
airport_chart.y_title = "Number of times runway repeats"
airport_chart.add("1", one_runway)
airport_chart.add("2", two_runways)
airport_chart.add("3", three_runways)
airport_chart.add("4", four_runways)
airport_chart.add("5", five_runways)
airport_chart.add("6", six_runways)
airport_chart.add("7", seven_runways)
airport_chart.add("8", eight_runways)
airport_chart.add("9", nine_runways)
airport_chart.add("10", ten_runways)
airport_chart.add("11", eleven_runways)
airport_chart.add("12", twelve_runways)
airport_chart.add("14", fourteen_runways)
airport_chart.add("15", fifteen_runways)
airport_chart.add("16", sixteen_runways)
airport_chart.add("20", twenty_runways)
airport_chart.add("26", twenty_six_runways)
airport_chart.add("31", thirty_one_runways)
airport_chart.add("32", thirty_two_runways)
airport_chart.add("42", fourty_two_runways)
airport_chart.add("48",fourty_eight_runways)
airport_chart.add("170", one_hundred_seventy_runways)

#adding to graph
airport_chart.render_to_file("airport chart.svg")
